...
namespace LINQ_Assignment_01
{
    ...
    internal static class ListGenerators 
    {
        ...
        static ListGenerators()
        {
            ...
            //Root refers to the root element of the XML document (the top-level element).
           // Elements("customer") gets all child elements of the root that are named "customer".Each customer element represents a single customer.
